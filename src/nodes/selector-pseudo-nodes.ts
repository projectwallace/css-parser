...
import { FLAG_VENDOR_PREFIXED, NODE_SELECTOR_PSEUDO_CLASS, NODE_SELECTOR_PSEUDO_ELEMENT } from '../arena'
...
export class SelectorPseudoClassNode extends CSSNodeBase {
	override get type(): typeof NODE_SELECTOR_PSEUDO_CLASS {
		return this.arena.get_type(this.index) as typeof NODE_SELECTOR_PSEUDO_CLASS
	}
...
export class SelectorPseudoElementNode extends CSSNodeBase {
	override get type(): typeof NODE_SELECTOR_PSEUDO_ELEMENT {
		return this.arena.get_type(this.index) as typeof NODE_SELECTOR_PSEUDO_ELEMENT
	}
